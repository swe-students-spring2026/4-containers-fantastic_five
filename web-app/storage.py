...
class SessionStorage:
    ...
    def create_session(self, session_id: str, questions: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    def save_response(
        ...
        transcript_file = self._session_dir(session_id) / "transcripts" / f"{question_id}.txt"
